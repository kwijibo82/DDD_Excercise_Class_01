...
namespace DocDbSamples.DocumentManagment
{
    // ----------------------------------------------------------------------------------------------------------
    // Prerequistes - 
    // 
    ...
    public class DocumentManagerSample
    {
        ...
        public static void RunSample()
        {
            try
            {
                ...
                connectionPolicy.PreferredLocations.Add(LocationNames.WestEurope); // first preference
        ...
        private static async Task CreateDocumentsAsync()
        {
            ...
            await _client.CreateDocumentAsync(collectionUri, salesOrder);
            ...
            await _client.CreateDocumentAsync(collectionUri, newSalesOrder);
        }
        ...
        private static async Task ReadDocumentAsync()
        {
            ...
            foreach (Document document in await _client.ReadDocumentFeedAsync(
        ...
        private static SalesOrder QueryDocuments()
        {
            ...
            SalesOrder querySalesOrder = _client.CreateDocumentQuery<SalesOrder>(
                UriFactory.CreateDocumentCollectionUri(databaseName, collectionName))
        ...
        private static async Task ReplaceDocumentAsync(SalesOrder order)
        {
            ...
            ResourceResponse<Document> response = await _client.ReplaceDocumentAsync(
        ...
        private static async Task UpsertDocumentAsync()
        {
            ...
            ResourceResponse<Document> response = await _client.UpsertDocumentAsync(UriFactory.CreateDocumentCollectionUri(databaseName, collectionName), upsertOrder);
            ...
            response = await _client.UpsertDocumentAsync(UriFactory.CreateDocumentCollectionUri(databaseName, collectionName), upserted);
        ...
        private static async Task DeleteDocumentAsync()
        {
            ...
            ResourceResponse<Document> response = await _client.DeleteDocumentAsync(
        ...
        private static async Task RunBasicOperationsOnDynamicObjects()
        {
            ...
            ResourceResponse<Document> response = await _client.CreateDocumentAsync(collectionLink, salesOrder);
            ...
            response = await _client.ReadDocumentAsync(
            ...
            response = await _client.ReplaceDocumentAsync(salesOrder);
        ...
        private static async Task UseETags()
        {
            ...
            //read a document
            Document readDoc = await _client.ReadDocumentAsync(
                UriFactory.CreateDocumentUri(databaseName, collectionName, "SalesOrder1"),
                new RequestOptions { PartitionKey = new PartitionKey("Account1") });
            ...
            Document updatedDoc = await _client.ReplaceDocumentAsync(readDoc);
            ...
            try
            {
                ...
                updatedDoc = await _client.ReplaceDocumentAsync(readDoc, new RequestOptions { AccessCondition = ac });
            }
            ...
            response = await _client.ReplaceDocumentAsync(readDoc);
        ...
        private static async Task UseConsistencyLevels()
        {
            ...
            ResourceResponse<Document> response = await _client.ReadDocumentAsync(
                UriFactory.CreateDocumentUri(databaseName, collectionName, "SalesOrder2"),
                new RequestOptions
                {
                    PartitionKey = new PartitionKey("Account2"),
